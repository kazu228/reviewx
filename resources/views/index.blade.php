    ...
    <body id="page-top">
        ...
        <header class="masthead d-flex align-items-center">
            ...
            <div class="container px-4 px-lg-5 text-center">
                ...
                <a class="btn btn-primary btn-xl" href="{{ route('home') }}">初めてみる</a>
            </div>
        </header>
        <!-- About-->
        <section class="content-section bg-light" id="about">
            <div class="container px-4 px-lg-5 text-center">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-10">
                        <h2 class="mb-5">いろいろな人に自分の書いたコードをレビューしてもらう<br>あるいは、レビューするサービスです!</h2>
                        {{-- <p class="lead mb-5">
                        ...
                        <a class="btn btn-primary btn-xl" href="{{ route('home') }}">初めてみる</a>
                        {{-- <a class="btn btn-dark btn-xl" href="{{ route('home') }}">初めてみる</a> --}}
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row gx-0">
                    <div class="col-lg-6">
                        <a class="portfolio-item" href="#!">
                            ...
                            <img class="img-fluid" src="{{ asset('img/img/portfolio-1.jpg') }}" alt="..." />
                        </a>
                    </div>
                    <div class="col-lg-6">
                        <a class="portfolio-item" href="#!">
                            ...
                            <img class="img-fluid" src="{{ asset('img/img/portfolio-2.jpg') }}" alt="..." />
                        </a>
                    </div>
                    <div class="col-lg-6">
                        <a class="portfolio-item" href="#!">
                            ...
                            <img class="img-fluid" src="{{ asset('img/img/portfolio-3.jpg') }}" alt="..." />
                        </a>
                    </div>
                    <div class="col-lg-6">
                        <a class="portfolio-item" href="#!">
                            ...
                            <img class="img-fluid" src="{{ asset('img/img/portfolio-4.jpg') }}" alt="..." />
                        </a>
                    </div>
                </div>
            </div>
